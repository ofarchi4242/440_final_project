...
celltypes = ['Astrocytes', 'Endothelial', 'Ependymal', 'Microglia', 'Neurons', 'Oligodendrocyte PCs', 'Oligodendrocytes', 'Mural', 'Unknown2']
...
for idx,cell_type in enumerate(celltypes):
    ...
    plt.axvline(x=-0.25, color='black', linestyle='--', linewidth=0.8)  # Add a vertical line at logFC=-0.5
    plt.axvline(x=0.25, color='black', linestyle='--', linewidth=0.8)  # Add a vertical line at logFC=0.5
